    ...
    <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <td class="actions">
                ...
                <?php echo $this->Html->link(__('Download'), array('controller' => 'document_files', 'action' => 'get', $documentFile['DocumentFile']['id']), array('class' => 'btn btn-default btn-xs', 'target' => '_blank')); ?>
